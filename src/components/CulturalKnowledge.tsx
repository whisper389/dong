  ...
  const qiGreatWall: KnowledgeItem[] = [
    {
      ...
      content: `齐长城是中国现存最古老的长城，始建于春秋时期的齐国，比著名的秦长城还要早400多年，被誉为"长城之父"。齐长城西起黄河，东至黄海，全长1000多公里，横贯整个山东省。

**历史背景**
春秋时期，诸侯争霸，战争频繁。齐国为了防御楚国和鲁国的入侵，决定修建这道军事防御工程。齐长城的修建始于齐桓公时期（公元前7世纪），历经数代君主，断断续续修建了200多年才基本完成。

**建筑特色**
齐长城因地制宜，充分利用了山东的地形特点：
- 山区段：沿着山脊修建，利用险峻地势
- 平原段：挖掘壕沟，堆筑土墙
- 关隘设置：设有锦阳关、穆陵关等重要关隘
- 烽火台：沿线设置烽火台，形成通信网络
...
- 工程价值：体现了古代建筑工程技术
- 文化价值：承载着齐鲁文化的深厚底蕴
- 研究价值：为研究春秋战国历史提供实物资料

**现状保护**
齐长城虽然历经两千多年的风雨侵蚀，但至今仍有许多段落保存完好，已被列为全国重点文物保护单位。`,
